...
class App {
  ...
  _getPosition() {
    navigator.geolocation.getCurrentPosition(
      ...
      function () {
        alert('Couldnt get the position');
      }
    );
  }
  ...
  _newWorkout(e) {
    ...
    console.log(validInputs(2, 3, 4));
    console.log(postiveInputs(2, 5, 6));
    e.preventDefault();
    ...
    if (type === 'cycling') {
      ...
      console.log(type, typeof distance, typeof duration, typeof elevation);
      if (
